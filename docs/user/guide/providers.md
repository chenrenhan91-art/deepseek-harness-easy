...
This guide assumes you started the Web UI through [INSTALL.md](../../../INSTALL.md) or `pnpm dsh web`. Model changes take effect on the next request without restarting the server.
