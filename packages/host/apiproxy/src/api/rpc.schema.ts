...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('model-discovery-failed'), message: z.string(), details: z.object({
    settingsNs: z.string(),
    baseURL: z.string().optional(),
    reason: z.union([z.literal('invalid-credential'), z.literal('endpoint-unusable')]),
  }) }),
