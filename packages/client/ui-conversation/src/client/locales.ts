...
export const zh = {
  ...
  'access.confirm.title': '确认启用完全放开？',
  'access.confirm.description': '启用完全放开后，智能体将减少确认步骤，并且可以直接执行更多操作，包括敏感操作、文件修改或外部命令。仅建议在你信任当前任务时使用。',
  'access.confirm.acknowledge': '我已了解风险，并愿意继续',
  'access.confirm.cancel': '取消',
  'access.confirm.enable': '启用完全放开',
  ...
  'message.quota': '账户余额不足，请先充值后再试。',
  'message.quotaTopUp': '去充值（官方）',
  ...
  'tool.title.bash': '执行命令',
  'tool.title.write': '写入文件',
  'tool.title.edit': '修改文件',
  'tool.title.code': '运行代码',
  'tool.title.others': '工具调用',
  'tool.title.grep': '搜索内容',
  'tool.title.glob': '查找文件',
  'tool.title.webSearch': '联网搜索',
  'tool.title.webFetch': '打开网页',
  'tool.title.pwsh': 'PowerShell 命令',
  'tool.title.inspect': '查看插件',
  'tool.title.cordisRun': '启动插件',
  'tool.title.cordisStop': '停止插件',
  'tool.title.cordisRemove': '移除插件',
  'tool.io.input': '输入',
  'tool.io.output': '输出',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
...
export const en = {
  ...
  'message.quota': 'This account has no remaining balance. Top up, then try again.',
  'message.quotaTopUp': 'Top up (official)',
