...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-schedule': { kind: 'indirect', reason: 'The page dispatches /schedule command lines; dsh-schedule owns the model-visible tools, reminder framing, and logged schedule/change stream.' },
