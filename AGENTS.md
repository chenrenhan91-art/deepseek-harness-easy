...
If the user pasted this git URL, the GitHub Pages site, or asked to install / 安装 / open the workbench, follow [INSTALL.md](INSTALL.md) through `pnpm run desktop:install` until the Web workbench window is open; do not stop after clone.
