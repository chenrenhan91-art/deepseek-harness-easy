...
兼容 overlay：重述随附 Web 的 `time-context` 与 `schedule` 行，使 `dsh web --patch examples/web-schedule/cordis.yml` 仍然有效。绝对时间 authority 以及交付与恢复边界详见 [web-schedule/README.md](web-schedule/README.md)。
